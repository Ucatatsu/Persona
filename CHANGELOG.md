...
### Исправлено
- Кнопки мут/камера в звонках теперь корректно переключают SVG иконки
- Исправлена работа attach/emoji кнопок в группах, каналах и серверах
...
### Исправлено
- Исправлен класс dock-img для корректного отображения иконок
